import PANmodel from '../../../models/commissions/PANcommission.js'

export const createPANCommission = async (req, res) => {
  try {
    let data = req.body;
...
export const updatePANCommission = async (req, res) => {
  try {
    let data = req.body;
    let { slab, type, APIClient, master, distributor, retailer, commissionId } = data;
